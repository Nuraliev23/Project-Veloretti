  ...
  return (
    <>
      ...
      <section className="flex max-w-[1200px] mx-auto justify-between my-[80px] items-center flex-col md:flex-row">
        ...
        <div className="bg-[#EBEDEE] w-[48%] p-[15px] h-[400px]">
          <div className="flex justify-between">
            <p>Electric Ace</p>
            <p>€69,07 NET/MONTH</p>
          </div>
      ...
      >
        <h1 className="md:w-[30%] w-[90%] max-w-[1200px] text-[70px] text-[white] ">
        ...
        <p className="md:w-[30%] w-[90%] max-w-[1200px]  text-[white]">
          ...
          you're looking to pick up a newly ordered bike, need a fix, or want to
          take a test ride on our Ivy or Ace Two, your ideal biking experience
      ...
      <section className="flex flex-col gap-[16px] max-w-[1200px] mx-auto my-[90px]">
        ...
        <div className="flex items-center gap-[16px]">
          <div className="border-[1px] border-[#808080dc] p-[15px] h-[200px] flex flex-col justify-center gap-[20px]">
            <p>
      ...
      >
        ...
        <p className="md:w-[30%] w-[90%] max-w-[1200px]  text-[white]">
          Good design is what drives us, and we're proud to share that Veloretti
          Electric Two has already won the prestigious Red Dot Design Award
          2023, as judged by the world's best product designers.
        </p>
      </section>
      <section className="flex max-w-[1200px] mx-auto justify-between my-[80px] items-center flex-col md:flex-row">
        <div className="flex flex-col gap-[16px] md:w-[40%] w-[90%]">
